            ...
            <div className="wd-dashboard-course col" style={{ width: "300px"}}>
              <Link to={`/Kanbas/Courses/${course.number}/Home`} className="text-decoration-none" >
                <div className="card rounded-3 overflow-hidden">
                  <img src={course.image} height="160px" />
                  <div className="card-body">
                    <div className="wd-dashboard-course-link"
                      style={{ textDecoration: "none", color: "navy", fontWeight: "bold", maxHeight:"25px", overflow:"hidden", textOverflow:"ellipsis", whiteSpace:"nowrap"}} >
                      {course.name}
                    </div>
